...
BASE_DIR2 = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))  # C:\Users\BCTPK1\'
...
if socket.gethostname().endswith(".local"): # True in your local computer =='AP-MBeaW5Ur0LNf':#
    DEBUG = True
    ALLOWED_HOSTS = ['*']
else:
    DEBUG = True
...
# EMAIL_HOST_USER = 'pppradeepkumar376@gmail.com'
# EMAIL_HOST_PASSWORD = 'ohqelotyvmdhbtva'
