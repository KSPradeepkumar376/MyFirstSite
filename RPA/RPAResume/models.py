...
class Personaldetailsmodels(models.Model):
    ...
    Freelance = models.CharField(max_length=3,default=None, choices=Freelances,null=True)
...
class SkillsModel(models.Model):
    id = models.AutoField(auto_created = True,primary_key=True, help_text='Unique ID for this particular book across whole library')
    skill_id = models.ForeignKey(Personaldetailsmodels,null=True,on_delete=models.CASCADE)
...
class EducationModel(models.Model):
    id = models.AutoField(auto_created = True,primary_key=True, help_text='Unique ID for this particular book across whole library')
    Education_id = models.ForeignKey(Personaldetailsmodels,null=True,on_delete=models.CASCADE)
...
class CertificationModel(models.Model):
    TECHNICAL = (('T', 'TECHNICAL'), ('NT', 'Non TECHNICAL'),)
    id = models.AutoField(auto_created = True,primary_key=True, help_text='Unique ID for this particular book across whole library')
    Certification_id = models.ForeignKey(Personaldetailsmodels, null=True, on_delete=models.CASCADE)
    TECHNICAL = models.CharField(max_length=2, default=None, choices=TECHNICAL, null=True)
...
class ExperienceModel(models.Model):
    id = models.AutoField(auto_created = True,primary_key=True, help_text='Unique ID for this particular book across whole library')
    Experience_id = models.ForeignKey(Personaldetailsmodels, null=True, on_delete=models.CASCADE)
...
class SocialModel(models.Model):
    id = models.AutoField(auto_created = True,primary_key=True, help_text='Unique ID for this particular book across whole library')
    SocialMedia_id = models.ForeignKey(Personaldetailsmodels,null=True,on_delete=models.CASCADE)
...
class TestimonialsModel(models.Model):
    id = models.AutoField(auto_created = True,primary_key=True, help_text='Unique ID for this particular book across whole library')
    Testimonials_id = models.ForeignKey(Personaldetailsmodels,null=True,on_delete=models.CASCADE)
